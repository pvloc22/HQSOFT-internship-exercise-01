...
class BaseAppbar extends StatefulWidget implements PreferredSizeWidget{
  ...
  Size get preferredSize {
    return Size.fromHeight(kToolbarHeight + BaseBottomAppbar().preferredSize.height);
  }
...
class _BaseAppbarState extends State<BaseAppbar> {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      actions: [
        IconButton(onPressed: (){}, icon: FaIcon(FontAwesomeIcons.checkDouble, color: Colors.white,),),
        IconButton(onPressed: (){}, icon: FaIcon(FontAwesomeIcons.sliders, color: Colors.white,),),
      ],
